...
and per-event `UID`/`DTSTART`. See the roadmap in the project history
for what's next — timezone handling and property value escaping in
particular are not covered yet.
